...
import com.tdv.vrapp.UtilsKt;
import com.tdv.vrapp.webserver.WebServer;
...
public class VRBrowserActivity extends PlatformActivity implements WidgetManagerDelegate, ComponentCallbacks2, LifecycleOwner, ViewModelStoreOwner {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        EngineProvider.INSTANCE.getOrCreateRuntime(this).appendAppNotesToCrashReport("3DVista VR App " + BuildConfig.VERSION_NAME + "-" + BuildConfig.VERSION_CODE + "-" + BuildConfig.FLAVOR + "-" + BuildConfig.BUILD_TYPE + " (" + BuildConfig.GIT_HASH + ")");
    ...
    protected void initializeWidgets() {
        ...
        if (mWindows.getWindowsCount() == 0)
            mWindows.openNewTabAfterRestore("", Windows.OPEN_IN_NEW_WINDOW);
        else
            mWindows.getCurrentWindows().get(0).loadHome();
    }
